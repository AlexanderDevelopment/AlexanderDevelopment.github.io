...
- Reddit: `https://www.reddit.com/user/dreadway_the_game/`
...
- Update both the contact section and footer links in `index.html`.
- Keep the provider list in `privacy-policy.html` in sync.
- Keep this file and `Docs/README.md` in sync with the visible website links.
