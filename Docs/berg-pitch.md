...
- realistic social climbing adventure;
- first-person co-op for PC / Steam;
- accessible 12+ casual audience;
...
The current deck uses the three local Berg concept screenshots in:

`pitch/berg/`

The screenshots are embedded as visual mood and concept proof, not treated as final production art.
...
Current editable PowerPoint deck:

`pitch/berg/Berg_High_Concept_1_0_FFF_Bayern.pptx`

Current PDF export:

`pitch/berg/Berg_High_Concept_1_0_FFF_Bayern.pdf`

The PDF export is generated from 4x high-resolution slide renders when a native PowerPoint or LibreOffice vector export is unavailable on the local machine.

The deck has 10 slides:

1. Cover and elevator hook.
2. Elevator pitch and product framing.
3. Moment-to-moment climbing loop.
4. Mountain route and mission structure.
5. Simulation pillars.
6. Multiplayer / social mountain concept.
7. Progression and retention.
8. Market positioning.
9. FFF Bayern High Concept 2.0 phase scope.
10. Team, track record and funding ask.
